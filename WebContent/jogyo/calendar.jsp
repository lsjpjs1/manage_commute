...
long sumWorkTimePlanMilliSec = 0;
...

{
      ...
      if(!workStartPlan.equals("") && !workEndPlan.equals("")){
    	Date workStartRealDate = formatter.parse(workStartPlan);
  		
  		Date workEndRealDate = formatter.parse(workEndPlan);
  		
  		long diff = workEndRealDate.getTime() - workStartRealDate.getTime();
  		if(diff>=0){
  		sumWorkTimePlanMilliSec += diff;
  		}
      }
...
총 근무 시간 : <%=sumWorkTimePlanMilliSec/3600000 %> 시간
</div>
<br>
